...
> 迁移到原生 Ubuntu 开发机请先阅读 [MIGRATION_UBUNTU.md](MIGRATION_UBUNTU.md)。迁移包会保留已验证固件并排除 Windows 虚拟环境与秘密文件。
...
本仓当前采用 **原生 Ubuntu 开发、编译和烧录** 工作流。Windows-first 文档保留为历史参考；新机器请以迁移指南和状态文档为准，不要把已有目录或接口骨架视为已完成功能。

- [项目指南](PROJECT_GUIDE.md)
- [原生 Ubuntu 迁移指南](MIGRATION_UBUNTU.md)
- [Windows-first 历史方案](docs/windows_first_development_plan.md)
- [快速开始](QUICKSTART.md)
- [开发环境指南](docs/development_guide.md)
- [当前项目状态](STATUS.md)
- [脚本状态与计划](scripts/README.md)
